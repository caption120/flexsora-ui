    ...
    <header className="header">
      <div className="header-left">
        <div className="logo">
          ...
          <span className="logo-text">flexsora/ui</span>
      ...
      <div className="header-right">
        ...
        <a href="#github" className="icon-link" aria-label="GitHub Repository">
        ...
        <a href="#x" className="icon-link" aria-label="X Profile">
        ...
        <div className="theme-toggle" aria-label="Toggle theme">
          <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" height="1em" width="1em">
